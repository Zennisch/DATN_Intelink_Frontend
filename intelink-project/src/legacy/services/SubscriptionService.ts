...
} from "../dto/request/SubscriptionRequest.ts";
import type {
  SubscriptionResponse,
  GetAllSubscriptionsResponse,
  CancelSubscriptionResponse
} from "../dto/response/SubscriptionResponse.ts";

export class SubscriptionService {
  static async getCost(subscriptionPlanId: number, applyImmediately: boolean = false): Promise<import("../dto/response/SubscriptionCostResponse.ts").SubscriptionCostResponse> {
